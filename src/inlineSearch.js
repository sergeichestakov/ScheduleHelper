/*
This is NOT my code, this is merely a redeclaration of the function that displays the inline search results with the added features listed below
To go through all the changes simply Ctrl + F "Schedule Helper"

Modifications:
Lines 213 - 261: Find conflicts and color the data-item divs with corresponding color
Lines 285 - 288: Added the tooltip for conflicting classes
Lines 325 - 336: Rate my professor links
Lines 534 - 567: Adjusted widths for some divs and appended ratings
*/
UCD.SAOT.COURSES_SEARCH_INLINE.textSearch_success = function SAOTtextSearch_success(data){
	var messageContainer = document.getElementById("ErrorContainer");
	var callerString = arguments.callee.toString();
	
	try{
		/**/
		var ThisButton = $(".inline-search .btn")[0];
		var OtherButton = $(".inline-search .btn")[0];
		var CourseResultsContainer = document.getElementById("inlineCourseResultsDiv");
		var CourseSearchResultsContainer = $(".inline-search .course-search-results")[0];
		...
		/**/
		if($(CourseSearchResultsContainer).hasClass("hide")){
			$(CourseSearchResultsContainer).removeClass("hide");
		}
		
		//also, reset the hide/show if needed
		if($(".inline-search-results-hideshow-trigger .btn")[0].innerHTML=="Show Results"){
			$(".inline-search-results-hideshow-trigger .btn").click();
		}
		
		$("#inlineCourseResultsContainer").first().each(function(){
		...
		if(CourseResultsContainer!=null && data!=null && typeof data.Results !== "undefined" && typeof data.Results.DATA !== "undefined"){
			InlineCourseSearchResults = data.Results;
			...
			for(i=0;i < data.Results.DATA.length;i++){
					...
					if(currentCourseDeptSpecificNotesData!=null && currentCourseDeptSpecificNotesData!=""){
						try{
							...
							UCD.SAOT.Exceptions.errorHandler({
								...
								,"success":null
								,"error":null
								,"callerLineNumberErrorObject":new Error(""),"callerCFLineNumber":"6419"
				...
				if(UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"COURSEMEETINGDATA")!=""){
					...
					if(eval("typeof Schedules[ThisScheduleIndex].SelectedList.t"+UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"PASSEDCRN")+"!=='undefined'")){
						...
						for(var j=0; j < meetings.DATA.length && !conflicts; j++){
				...
				//Adds the background color (Schedule Helper)
				NewInnerHTML = NewInnerHTML + "<div class=\"data-item\" style=\"background-color: " + color + ";\">\
								<div class=\"data-row clearfix\">\
									<div id=\"InlineCourseSearchResultsRow"+i+"_ErrorContainer\" class=\"data-column\" style=\"width:100%;\">\
									</div>\
								</div>";
					...
					if(instructors!=null){
						for(j=0;j < instructors.DATA.length;j++){
							...
							if(UCD.SAOT.Util.JSON2CFQueryLookup(instructors,j,"EMAIL")!=""){
								...
								var link;
								if (ratings[last] && ratings[last][first]){
				...
				if(currentDescription!="" || currentPrerequisites!="" || currentGE2Credit!="" || currentGE3Credit!="" || currentFinalExamStartDate!=null || (UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="null" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")==0) || currentDropDate!=null || currentCrossListing!="" || currentCreditLimitation!="" || currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
					...
					NewInnerHTML = NewInnerHTML + "<div class=\"details hide\" id=\"InlineCourseSearchResultsRow"+i+"_Details_Long\">";
				...
				if(UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"COURSEMEETINGDATA")!=""){
					...
					for(j=0;j < meetings.DATA.length;j++){
						...
						if((ENDTIME!=null && STARTTIME!=null) || (UCD.SAOT.Util.JSON2CFQueryLookup(meetings,j,"WEEKDAYS")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(meetings,j,"WEEKDAYS")!="") || (UCD.SAOT.Util.JSON2CFQueryLookup(meetings,j,"bldg_desc")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(meetings,j,"bldg_desc")!="" && UCD.SAOT.Util.JSON2CFQueryLookup(meetings,j,"bldg_desc")!="TBA")){
							...
							if(j == 0 && last && ratings[last] && ratings[last][first]){
							...
							} else if(j == 1 && last && ratings[last] && ratings[last][first]){ //Append difficulty
				...
				if(eval("typeof Schedules[ThisScheduleIndex].SelectedList.t"+UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"PASSEDCRN")+"!=='undefined'")){
					...
					NewInnerHTML = NewInnerHTML + " white-on-navyblue btn-save\" onclick=\"javascript:UCD.SAOT.COURSES_SEARCH_INLINE.addCourse("+i+",this);\">Save</button>";
				}
				
				if(currentDescription!="" || currentPrerequisites!="" || currentGE2Credit!="" || currentGE3Credit!="" || currentFinalExamStartDate!=null || (UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="null" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")==0) || currentDropDate!=null || currentCrossListing!="" || currentCreditLimitation!="" || currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
					NewInnerHTML = NewInnerHTML + "<br/>";
					if(currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
						NewInnerHTML = NewInnerHTML + "<button type=\"button\" class=\"btn btn-mini btn-warning course-alerts\" onclick=\"javascript:HideShowContainerByID('InlineCourseSearchResultsRow"+i+"_Details_Long',this,'Hide Important Details','Show Important Details','toggle');\" title=\"View Course Iimportant Details\" style=\"text-decoration:none;\">Show Important Details</button>";
					}else{
						NewInnerHTML = NewInnerHTML + "<button type=\"button\" class=\"btn btn-mini white-on-navyblue\" onclick=\"javascript:HideShowContainerByID('InlineCourseSearchResultsRow"+i+"_Details_Long',this,'Hide&nbsp;Details','Show&nbsp;Details','toggle');\" title=\"View Course Details\" style=\"text-decoration:none;\">Show&nbsp;Details</button>";
					}
				}
				...
				if(currentDescription!="" || currentPrerequisites!="" || currentGE2Credit!="" || currentGE3Credit!="" || currentFinalExamStartDate!=null || (UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="null" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")==0) || currentDropDate!=null || currentCrossListing!="" || currentCreditLimitation!="" || currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
					NewInnerHTML = NewInnerHTML + "<div class=\"details hide\" id=\"InlineCourseSearchResultsRow"+i+"_Details_Medium\">";
				...
				if(currentDescription!="" || currentPrerequisites!="" || currentGE2Credit!="" || currentGE3Credit!="" || currentFinalExamStartDate!=null || (UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="null" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")==0) || currentDropDate!=null || currentCrossListing!="" || currentCreditLimitation!="" || currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
					NewInnerHTML = NewInnerHTML + "<br/>";
					if(currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
						NewInnerHTML = NewInnerHTML + "<button type=\"button\" class=\"btn btn-mini btn-warning course-alerts\" onclick=\"javascript:HideShowContainerByID('InlineCourseSearchResultsRow"+i+"_Details_Medium',this,'Hide Important Details','Show Important Details','toggle');\" title=\"View Course Important Details\" style=\"text-decoration:none;\">Show Important Details</button>";
					}else{
						NewInnerHTML = NewInnerHTML + "<button type=\"button\" class=\"btn btn-mini white-on-navyblue\" onclick=\"javascript:HideShowContainerByID('InlineCourseSearchResultsRow"+i+"_Details_Medium',this,'Hide&nbsp;Details','Show&nbsp;Details','toggle');\" title=\"View Course Details\" style=\"text-decoration:none;\">Show&nbsp;Details</button>";
					}
				}
				...
				if(currentDescription!="" || currentPrerequisites!="" || currentGE2Credit!="" || currentGE3Credit!="" || currentFinalExamStartDate!=null || (UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="null" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")==0) || currentDropDate!=null || currentCrossListing!="" || currentCreditLimitation!="" || currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){												
					if(currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
						NewInnerHTML = NewInnerHTML + "<button type=\"button\" class=\"btn btn-mini btn-warning course-alerts\" onclick=\"javascript:HideShowContainerByID('InlineCourseSearchResultsRow"+i+"_Details_Short',this,'Hide Important Details','Show Important Details','toggle');\" title=\"View Course Important Details\" style=\"text-decoration:none;\">Show Important Details</button>";
					}else{
						NewInnerHTML = NewInnerHTML + "<button type=\"button\" class=\"btn btn-mini white-on-navyblue\" onclick=\"javascript:HideShowContainerByID('InlineCourseSearchResultsRow"+i+"_Details_Short',this,'Hide&nbsp;Details','Show&nbsp;Details','toggle');\" title=\"View Course Details\" style=\"text-decoration:none;\">Show&nbsp;Details</button>";
					}
				}
				...
				if(currentDescription!="" || currentPrerequisites!="" || currentGE2Credit!="" || currentGE3Credit!="" || currentFinalExamStartDate!=null || (UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="null" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CourseMaterialsTerm")!="" && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")!=null && UCD.SAOT.Util.JSON2CFQueryLookup(data.Results,i,"CONSENTOFINSRUCTORREQUIRED")==0) || currentDropDate!=null || currentCrossListing!="" || currentCreditLimitation!="" || currentCourseSpecificNotesDataObject!=null || currentCourseDeptSpecificNotesDataObject!=null || currentCourseSubjectSpecificNotesDataObject!=null){
					NewInnerHTML = NewInnerHTML + "<div class=\"details hide\" id=\"InlineCourseSearchResultsRow"+i+"_Details_Short\">";
			...
			/**/
			UCD.SAOT.DATA.LAYOUTS.LongShort.setLayouts(document.getElementById("inlineCourseResultsDiv"));
			
			var ThisButton = $(".inline-search").data("SubmitButton");
			UCD.SAOT.SpinJS.swapOutSpinner(ThisButton);
			
			/**/
			//document.location.hash = "#InlineCourseSearchResults";
			...
			if(data.Results.DATA.length>0){
				MYUCD.Help.Tour.processTourSteps("UCD.SAOT.COURSES_SEARCH_INLINE.textSearch-Success");
			}else{
				MYUCD.Help.Tour.processTourSteps("UCD.SAOT.COURSES_SEARCH_INLINE.textSearch-Error");
			}
		...
		UCD.SAOT.Exceptions.errorHandlerTryCatchHelper(e,arguments.callee.toString(),new Error(""),"7336",document.getElementById("courseResultsAlerts"),"","",UCD.SAOT.AJAX_TIMEOUT,ShowDebug);
